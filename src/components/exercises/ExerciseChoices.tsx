        ...
        {options.map((option, index) => {
          ...
          return (
            <button
              ...
              className={cn(
                'min-h-[5.25rem] rounded-[1.5rem] border px-4 py-4 text-left transition',
            ...
            >
              ...
              {option.description ? (
                <div className="mt-1 text-sm leading-6 text-white/50">{option.description}</div>
              ) : null}
            </button>
          )
        })}
